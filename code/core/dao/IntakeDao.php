<?php
 ...
 /**
  * Intake Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Intake object instances. 
  */
...
class IntakeDao {
    ...
    function load(&$conn, &$valueObject) {
          ...
          $sql = "SELECT * FROM intake WHERE (id = ".$valueObject->getId().") "; 
    ...
    function loadAll(&$conn) {
          ...
          $sql = "SELECT * FROM intake ORDER BY id ASC ";
    ...
    function create(&$conn, &$valueObject) {
          ...
          $sql = "INSERT INTO intake ( name, description) VALUES ('".$valueObject->getName()."', ";
    ...
    function save(&$conn, &$valueObject) {
          ...
          $sql = "UPDATE intake SET name = '".$valueObject->getName()."', ";
    ...
    function delete(&$conn, &$valueObject) {
          ...
          $sql = "DELETE FROM intake WHERE (id = ".$valueObject->getId().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM intake WHERE 1=1 ";
