<?php
 ...
 /**
  * Period Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Period object instances. 
  */
...
class PeriodDao {
    ...
    function load(&$conn, &$valueObject) {
          ...
          $sql = "SELECT * FROM period WHERE (id = ".$valueObject->getId().") "; 
    ...
    function loadAll(&$conn) {
          ...
          $sql = "SELECT * FROM period ORDER BY id ASC ";
    ...
    function create(&$conn, &$valueObject) {
          ...
          $sql = "INSERT INTO period ( name, starDate, endDate) VALUES ('".$valueObject->getName()."', ";
          $sql = $sql."'".$valueObject->getStarDate()."', ";
    ...
    function save(&$conn, &$valueObject) {
          ...
          $sql = "UPDATE period SET name = '".$valueObject->getName()."', ";
          $sql = $sql."starDate = '".$valueObject->getStarDate()."', ";
    ...
    function delete(&$conn, &$valueObject) {
          ...
          $sql = "DELETE FROM period WHERE (id = ".$valueObject->getId().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          if ($valueObject->getStarDate() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND starDate = '".$valueObject->getStarDate()."' ";
          }
